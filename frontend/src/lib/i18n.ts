...
const strings: Record<string, string> = {
  ...
  'item.item.tidewrought_blade': 'Tidewrought Blade',
  'item.item.causeway_maul': 'Causeway Maul',
  'item.item.husk_scale_helm': 'Husk-scale Helm',
  'item.item.lurker_hide_leggings': 'Lurker-hide Leggings',
  'item.item.marshwalker_boots': 'Marshwalker Boots',
  'item.item.chanters_torc': "Chanter's Torc",

  'item.item.vault_greatmaul': 'Vault Greatmaul',
  'item.item.emberglass_edge': 'Emberglass Edge',
  'item.item.ashcallers_rod': "Ashcaller's Rod",
  'item.item.sentinel_cuirass': 'Sentinel Cuirass',
  'item.item.ashen_visor': 'Ashen Visor',
  'item.item.emberbound_gauntlets': 'Emberbound Gauntlets',
  'item.item.warden_signet': 'Warden Signet',

  'item.item.cinderforged_greataxe': 'Cinderforged Greataxe',
  'item.item.reachwarden_blade': 'Reachwarden Blade',
  'item.item.pyre_sigil': 'Pyre Sigil',
  'item.item.slagplate_harness': 'Slagplate Harness',
  'item.item.reachwarden_pauldrons': 'Reachwarden Pauldrons',
  'item.item.emberwake_treads': 'Emberwake Treads',
  'item.item.cinderglass_amulet': 'Cinderglass Amulet',
  'item.item.sovereigns_band': "Sovereign's Band",
  ...
  'ability.ability.call_the_tide': 'Call the Tide',
  'ability.ability.tidal_surge': 'Tidal Surge',
  'ability.ability.warding_flame': 'Warding Flame',
  'ability.ability.pyre_mark': 'Pyre Mark',
  'ability.ability.cinder_execution': 'Cinder Execution',
  'ability.ability.emberwake_roar': 'Emberwake Roar',
  'ability.ability.slag_sweep': 'Slag Sweep',
  ...
  'effect.effect.rising_tide': 'Rising Tide',
  'effect.effect.pyre_mark': 'Pyre-marked',
  'effect.effect.emberwake': 'Emberwake',
  ...
  'monster.monster.span_leech': 'Span Leech',
  'monster.monster.tide_herald': 'Tide Herald',
  'monster.monster.reach_pyrebinder': 'Reach Pyrebinder',
  'monster.monster.reach_executioner': 'Reach Executioner',
  'monster.monster.slagborn_hulk': 'Slagborn Hulk',
  'monster.monster.cinder_sovereign': 'The Cinder Sovereign',
  ...
  'encounterName.encounter.stretch2_5.span': 'The Drowned Span',
  'encounterName.encounter.stretch2_5.herald': 'The Tide Herald',
  'encounterName.encounter.stretch3.warden_of_ash': 'The Warden of Ash',
  'encounterName.encounter.stretch4.reach_watch': 'Reach Watch',
  'encounterName.encounter.stretch4.slag_line': 'The Slag Line',
  'encounterName.encounter.stretch4.execution': 'The Execution',
  'encounterName.encounter.stretch4.cinder_sovereign': 'The Cinder Sovereign',
